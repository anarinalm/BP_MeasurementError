...
sample_diab_yes <- subset_diab_yes[sample(1:nrow(subset_diab_yes), 65, replace=FALSE),]
sample_diab_no <- subset_diab_no[sample(1:nrow(subset_diab_no), 435, replace=FALSE),]
...
reliability <- 0.001	### Set up measurement error with 0.5 Attenuation coef
sigma_u_sq <- 1/reliability - 1
...
>>>>>>> 1a807bef35a190e842b7154541e3fc2a0ee9249c
