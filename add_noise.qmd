...
sample_diab_yes <- subset_diab_yes[sample(1:nrow(subset_diab_yes), 20, replace=FALSE),]
sample_diab_no <- subset_diab_no[sample(1:nrow(subset_diab_no), 130, replace=FALSE),]
...
Here we can see that with a p-value of 0.023, there is a significant difference between the two populations. The diabetes group has a mean blood pressure of about 137, while the non-diabetes group has a mean of about 124.
...
reliability <- 0.0025	### Set up measurement error with 0.5 Attenuation coef
sigma_u_sq <- 1/reliability - 1
...
```{r}
print(paste("Reliability 0.3 Correlation Coefficient:", cor(subset_nhanes$bp_sys_mean, subset_nhanes$bp_sys_mean_noise_low))) 
print(paste("Reliability 0.5 Correlation Coefficient:", cor(subset_nhanes$bp_sys_mean, subset_nhanes$bp_sys_mean_noise_med))) 
print(paste("Reliability 0.7 Correlation Coefficient:", cor(subset_nhanes$bp_sys_mean, subset_nhanes$bp_sys_mean_noise_high))) 
